...
#define SMOKE_ANIM_PATTERN 8 //煙のアニメーションパターン
#define SMOKE_ANIM_COUNT 3 //このフレーム毎で更新
#define SMOKE_SIZE 80.0f //煙サイズ
...
HRESULT CBoxEffect::Load(void)
{
	...
	//テクスチャ読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/explosion000.png", &m_pTexture[TYPE_SMOKE]);
	return S_OK;
}
//-----------------------------------------------------------
// テクスチャ破棄
